Public Class Form1
    ...
    Public fridgeSupplies As New List(Of Item)
    Public otherSupplies As New List(Of Item)
    ...
    Private Sub CreateDefaultShoppingLists()
        ...
        fridgeSupplies.Add(New Item("Milk", 3))
        fridgeSupplies.Add(New Item("Apples", 5))
        fridgeSupplies.Add(New Item("Pop", 0))
        fridgeSupplies.Add(New Item("Water Bottles", 0))
        otherSupplies.Add(New Item("Toilet Rolls", 3))
        otherSupplies.Add(New Item("Soap Bottle", 0))
        otherSupplies.Add(New Item("Detergent", 0))
        otherSupplies.Add(New Item("Toothpaste", 2))
    End Sub
