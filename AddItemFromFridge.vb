Public Class AddItemFromFridge
    Private Sub ItemNameLabel_Click(sender As Object, e As EventArgs) Handles ItemNameLabel.Click

    End Sub

    Private Sub AddSupButton_Click(sender As Object, e As EventArgs) Handles AddSupButton.Click
    ...
    Private Sub Canceller_Click(sender As Object, e As EventArgs) Handles Canceller.Click
        Me.Close()
    End Sub

    Private Sub AddItemFromFridge_Load(sender As Object, e As EventArgs) Handles MyBase.Load
